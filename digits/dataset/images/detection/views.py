...
from .forms import ObjectDetectionDatasetForm
from .job import ObjectDetectionDatasetJob
...
def new():
    ...
    return flask.render_template('datasets/images/detection/new.html', form=form)
...
def create():
    """
    Creates a new ObjectDetectionDatasetJob
    ...
    if not form.validate_on_submit():
        if request_wants_json():
            ...
            return flask.render_template('datasets/images/detection/new.html', form=form), 400

    job = None
    try:
        job = ObjectDetectionDatasetJob(
...
def show(job, related_jobs=None):
    ...
    """
    return flask.render_template('datasets/images/detection/show.html', job=job, related_jobs=related_jobs)


def summary(job):
    """
    Return a short HTML summary of an ObjectDetectionDatasetJob
    """
    return flask.render_template('datasets/images/detection/summary.html',
                                 dataset=job)
